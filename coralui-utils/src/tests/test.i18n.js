...
describe('i18n', function() {
  ...
  describe('get', function() {
    ...
    it('should support single key, with named arguments, without translation hints', function() {
      ...
      expect(i18n.get('English string: {name1}, {name2}, and {name3}', { name1: 'foo', name2: 'bar', name3: 'qux' })).to.equal('Translated string: qux, foo, and bar');
    });
    ...
    it('should support single key, with named arguments, with translation hints', function() {
      ...
      expect(i18n.get('English string: {name1}, {name2}, and {name3}', { name1: 'foo', name2: 'bar', name3: 'qux' }, 'Translation hint 1')).to.equal('Translated string 1: qux, foo, and bar');
      expect(i18n.get('English string: {name1}, {name2}, and {name3}', { name1: 'foo', name2: 'bar', name3: 'qux' }, 'Translation hint 2')).to.equal('Translated string 2: qux, foo, and bar');
    });
    ...
    it('should support multiple keys, with named arguments, without translation hints', function() {
      ...
      expect(i18n.get('English string 13: {name1}, {name2}, and {name3}', { name1: 'foo', name2: 'bar', name3: 'qux' })).to.equal('Translated string 13: qux, foo, and bar');
      expect(i18n.get('English string 14: {name1}, {name2}, and {name3}', { name1: 'foo', name2: 'bar', name3: 'qux' })).to.equal('Translated string 14: qux, foo, and bar');
    });
    ...
    it('should support multiple keys, with named arguments, with translation hints', function() {
      ...
      expect(i18n.get('English string: {name1}, {name2}, and {name3}', { name1: 'foo', name2: 'bar', name3: 'qux' }, 'Translation hint 21')).to.equal('Translated string 21: qux, foo, and bar');
      expect(i18n.get('English string: {name1}, {name2}, and {name3}', { name1: 'foo', name2: 'bar', name3: 'qux' }, 'Translation hint 22')).to.equal('Translated string 22: qux, foo, and bar');
    });
