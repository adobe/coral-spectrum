describe('Coral.Select.Item', function() {
  ...
  describe('API', function() {
    ...
    beforeEach(function() {
      el = helpers.build(new Coral.Select.Item());
    });
  ...
  describe('Markup', function() {
    ...
    describe('#content', function() {
      ...
      it('should have content set to innerHTML if property not provided', function() {
        const el = helpers.build(window.__html__['Coral.Select.Item.base.html']);
        expect(el.content.innerHTML).to.equal('Costa Rica');
        expect(el.value).to.equal('Costa Rica');
      });

      it('should support HTML content', function() {
        const el = helpers.build(window.__html__['Coral.Select.Item.full.html']);
