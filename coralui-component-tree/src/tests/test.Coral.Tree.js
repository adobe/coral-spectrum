describe('Coral.Tree', function() {
  ...
  describe('Instantiation', function() {
    ...
    it('should be possible to clone nested tree using markup', function() {
      helpers.cloneComponent(window.__html__['Coral.Tree.nested.html']);
    });
    
    it('should be possible to clone tree with interactive elements', function() {
      helpers.cloneComponent(window.__html__['Coral.Tree.interactive.html']);
    });
    
    it('should be possible to clone using js', function() {
      const el = new Coral.Tree();
      el.items.add(new Coral.Tree.Item());
  ...
  describe('API', function() {
    ...
    describe('#parent', function() {
      ...
      it('should retrieve the parent tree', function() {
        const el = helpers.build(window.__html__['Coral.Tree.nested.html']).items.first();
  ...
  describe('Events', function() {
    ...
    describe('#coral-collection:add', function() {
      it('should be triggered with add()', function(done) {
        var el = helpers.build(new Coral.Tree());
      ...
      it('should be triggered with add() for nested items', function(done) {
        const el = helpers.build(window.__html__['Coral.Tree.base.html']).items.first();
        var spy = sinon.spy();
  ...
  describe('Implementation Details', function() {
    ...
    beforeEach(function() {
      el = helpers.build(new Coral.Tree());
  ...
  describe('#InteractiveElements', function() {
    ...
    it('should not select item when checkbox checked', function() {
      const el = helpers.build(window.__html__['Coral.Tree.interactive.html']);
      var item = el.items.getAll()[0];
      assertActiveness(item, false, false);
