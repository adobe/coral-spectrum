describe('Coral.ColumnView', function() {
  ...
  describe('Instantiation', function() {
    it('should be possible to clone via markup', function() {
      helpers.cloneComponent(window.__html__['Coral.ColumnView.full.html']);
    });
  });
  ...
  describe('API', function() {
    ...
    beforeEach(function() {
      ...
      el = helpers.build(new Coral.ColumnView());
    });
  ...
  describe('Events', function() {
    ...
    describe('#coral-columnview:change', function() {
      ...
      it('should be triggered when an item is selected', function() {
        const el = helpers.build(window.__html__['Coral.ColumnView.selectionMode.multiple.html']);
        // no initial events
        expect(columnActiveChangeSpy.callCount).to.equal(0);
        expect(changeSpy.callCount).to.equal(0);
      ...
      it('should be triggered when an item is activated (selectionMode=single)', function() {
        const el = helpers.build(window.__html__['Coral.ColumnView.selectionMode.single.html']);
        // no initial events
        expect(columnActiveChangeSpy.callCount).to.equal(0);
        expect(changeSpy.callCount).to.equal(0);
    ...
    describe('#coral-columnview:navigate', function() {
      it('should not be triggered when the column view initializes', function() {
        ...
        helpers.build(window.__html__['Coral.ColumnView.full.html']);
        // no initial events
