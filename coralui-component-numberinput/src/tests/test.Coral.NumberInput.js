describe('Coral.NumberInput', function() {
  ...
  describe('Instantiation', function() {
    it('should be possible using new', function() {
      var el = helpers.build(new Coral.NumberInput());
      testInstance(el);
    });
    ...
    it('should be possible using markup', function() {
      const el = helpers.build(window.__html__['Coral.NumberInput.base.html']);
      testInstance(el);
    });
  ...
  describe('Events', function() {
    ...
    describe('#change', function() {
      ...
      it('should trigger change when interacted with the mousewheel', function() {
        ...
        const el = helpers.build(window.__html__['Coral.NumberInput.full.html']);
        // adds the required listeners
        el.on('change', changeSpy);
