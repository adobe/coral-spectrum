import {getIndexOf, getRows, getColumns, getHeaderCells} from '../src/scripts/TableUtil';
...
describe('Coral.Table', function() {
  ...
  describe('Namespace', function() {
    ...
    it('should expose enums', function() {
      expect(Coral.Table).to.have.property('variant');
      expect(Coral.Table).to.have.property('divider');
    });
  });
  ...
  describe('Instantiation', function() {
    ...
    it('should be possible to clone using markup', function() {
      helpers.cloneComponent(window.__html__['Coral.Table.base.html']);
    });
  });
  ...
  describe('API', function() {
    ...
    describe('#items', function() {
      ...
      it('should append a coral-table-body if none', function() {
        var table = helpers.build(window.__html__['Coral.Table.empty.html']);
        var row = table.items.add(document.createElement('tr', 'coral-table-row'));
      ...
      it('should trigger coral-collection:remove', function(done) {
        var table = helpers.build(new Coral.Table());
        var eventSpy = sinon.spy();
      ...
      it('should disable table features if no items', function() {
        var table = helpers.build(window.__html__['Coral.Table.selectable.empty.html']);
      ...
      it('should be possible to declare items without table body', function() {
        var table = helpers.build(window.__html__['Coral.Table.rowsonly.html']);
    ...
    describe('#selectable', function() {
      ...
      it('should remove selection mode', function() {
        var table = helpers.build(window.__html__['Coral.Table.selectable.html']);
      ...
      it('should trigger a change event if selectable is set to false with selected items', function() {
        var table = helpers.build(window.__html__['Coral.Table.selectable.all.html']);
        var eventSpy = sinon.spy();
    ...
    describe('#lockable', function() {
      ...
      it('should remove lockable mode', function() {
        var table = helpers.build(window.__html__['Coral.Table.lockable.html']);
    ...
    describe('#coral-table-select', function() {
      ...
      it('should set the select all handle to indeterminate state on initialization', function() {
        var table = helpers.build(window.__html__['Coral.Table.preselected.html']);
  ...
  describe('Events', function() {
    describe('#coral-table:change', function() {
      ...
      it('should not trigger coral-table:change event when sorting', function() {
        var eventSpy = sinon.spy();
        var table = helpers.build(window.__html__['Coral.Table.sortable.html']);
    ...
    describe('#coral-table:rowchange', function() {
      it('should trigger when selecting a cell', function() {
        var table = helpers.build(window.__html__['Coral.Table.selectable.cell.html']);
        var eventSpy = sinon.spy();
    ...
    describe('#coral-table:beforecolumndrag', function() {
      it('should trigger when dragging the header cell to the left', function(done) {
        var eventSpy = sinon.spy();
        var table = helpers.build(window.__html__['Coral.Table.orderable.column.html']);
  ...
  describe('Implementation Details', function() {
    ...
    describe('#selectable', function() {
      it('should allow input without selecting the row', function() {
        var table = helpers.build(window.__html__['Coral.Table.selectable.input.html']);
        var row = table.body.rows[0];
    ...
    describe('#sticky', function() {
      ...
      it('should scroll to the table right in sticky mode', function(done) {
        var table = helpers.build(window.__html__['Coral.Table.sticky.orderable.column.html']);
        var headerCell = table.head.rows[0].cells[0];
        var container = table._elements.container;
      ...
      it.skip('should calculate head placeholder size if head is sticky', function(done) {
        ...
        window.setTimeout(function() {
          ...
          expect(table.head.divider).to.equal(Coral.Table.divider.CELL);
      ...
      it('should scroll the sticky headercells when scrolling the table', function(done) {
        var table = helpers.build(window.__html__['Coral.Table.sticky.html']);
      ...
      it('should not set a 0 width to the header cells if they are hidden', function(done) {
        var table = helpers.build(window.__html__['Coral.Table.sticky.hidden.html']);
        var wait = table._wait;
        table._wait = 0;
        table.hidden = false;
    ...
    describe('#fixedWidth', function() {
      it('should set a fixed width to the column', function() {
        var table = helpers.build(window.__html__['Coral.Table.fixedwidth.html']);
    ...
    describe('#sortable', function() {
      ...
      it('should sort ascending by alphanumeric type by default', function() {
        var table = helpers.build(window.__html__['Coral.Table.sortable.default.html']);
      ...
      it('should sort by alphanumeric type ascending using cells value property', function() {
        var eventSpy = sinon.spy();
        var table = helpers.build(window.__html__['Coral.Table.sortable.value.html']);
        table.on('coral-table:columnsort', eventSpy);
      ...
      it('should disable row ordering if table is in a sorted state (ascending)', function() {
        var eventSpy = sinon.spy();
        var table = helpers.build(window.__html__['Coral.Table.orderable.hidden.html']);
        table.on('coral-table:columnsort', eventSpy);
