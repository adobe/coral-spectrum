describe('Coral.Table.Body', function() {
  ...
  describe('Instantiation', function() {
    it('should be possible using new', function() {
      ...
      expect(el.classList.contains('coral-Table-body')).to.be.true;
    });
  ...
  describe('API', function() {
    ...
    describe('#divider', function() {
      it('should default to row divider', function() {
        ...
        expect(el.classList.contains('coral-Table-divider--row')).to.be.true;
        expect(el.classList.contains('coral-Table-divider--column')).to.be.false;
        expect(el.classList.contains('coral-Table-divider--cell')).to.be.false;
      });
      ...
      it('should apply column divider', function() {
        ...
        expect(el.classList.contains('coral-Table-divider--column')).to.be.true;
        expect(el.classList.contains('coral-Table-divider--row')).to.be.false;
        expect(el.classList.contains('coral-Table-divider--cell')).to.be.false;
      });
      ...
      it('should apply cell divider', function() {
        ...
        expect(el.classList.contains('coral-Table-divider--cell')).to.be.true;
        expect(el.classList.contains('coral-Table-divider--column')).to.be.false;
        expect(el.classList.contains('coral-Table-divider--row')).to.be.false;
      });
    });
