describe('Coral.keys', function() {
  ...
  it('should not trigger handlers when an event originates from an input', function() {
    ...
    helpers.build(window.__html__['Coral.keys.inputs.html']);
  ...
  it('should support a map of keyCombos to handlers with delegation', function() {
    const snippet = helpers.build(window.__html__['Coral.keys.keyComboMapWithDelegation.html']);
  ...
  it('should support custom filter functions', function() {
    const snippet = helpers.build(window.__html__['Coral.keys.filter.html']);
  ...
  it('should support event delegation', function() {
    ...
    helpers.build(window.__html__['Coral.keys.delegation.html']);
  ...
  it('should support event data with delegation', function() {
    const snippet = helpers.build(window.__html__['Coral.keys.dataWithDelegation.html']);
    var spy = sinon.spy();
  ...
  it('should scope events to a given element', function() {
    const snippet = helpers.build(window.__html__['Coral.keys.scoped.html']);
