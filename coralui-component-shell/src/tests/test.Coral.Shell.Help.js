describe('Coral.Shell.Help', function() {
  ...
  describe('Namespace', function() {
    it('should be defined in the Coral.Shell namespace', function() {
      ...
      expect(Coral.Shell.Help).to.have.property('Item');
    });
  });
  ...
  describe('Instantiation', function() {
    ...
    it('should create a help component with predefined items', function() {
      const el = helpers.build(window.__html__['Coral.Shell.Help.base.html']);
      expect(el.items.length).to.equal(6);
    });
  
    it('should be possible to clone using markup', function() {
      helpers.cloneComponent(window.__html__['Coral.Shell.Help.base.html']);
    });
  
    it('should be possible to clone using js', function() {
      const el = new Coral.Shell.Help();
