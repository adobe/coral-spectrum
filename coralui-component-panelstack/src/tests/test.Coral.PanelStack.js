describe('Coral.PanelStack', function() {
  ...
  describe('Instantiation', function() {
    ...
    it('should be possible using new', function() {
      var el = helpers.build(new Coral.PanelStack());
    ...
    it('should be possible to clone the element using markup', function() {
      helpers.cloneComponent(window.__html__['Coral.PanelStack.base.html']);
    });

    it('should be possible via cloneNode using js', function() {
      helpers.cloneComponent(new Coral.PanelStack());
    });
  });
  ...
  describe('Markup', function() {
    describe('#selectedItem', function() {
      it('should not automatically select an item', function() {
        const el = helpers.build(window.__html__['Coral.PanelStack.base.html']);
        expect(el.selectedItem).to.be.null;
      });
      
      it('should take the last selected', function() {
        helpers.target.innerHTML = window.__html__['Coral.PanelStack.doubleselected.html'];
      ...
      it('should read the selected from the markup', function() {
        const el = helpers.build(window.__html__['Coral.PanelStack.selectedItem.html']);
  ...
  describe('Collection API', function() {
    ...
    beforeEach(function() {
      el = helpers.build(new Coral.PanelStack());
    ...
    it('triggers coral-collection:remove on removeChild', function(done) {
      ...
      var el = helpers.build(window.__html__['Coral.PanelStack.base.html']);
    ...
    it('#add should also support config', function(done) {
      ...
      expect(ret instanceof Coral.Panel).to.be.true;
