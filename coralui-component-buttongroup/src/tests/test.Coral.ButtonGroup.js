describe('Coral.ButtonGroup', function() {
  ...
  describe('Instantiation', function() {
    it('should be possible to clone using markup', function() {
      helpers.cloneComponent(window.__html__['Coral.ButtonGroup.base.html']);
    });
  ...
  describe('Markup', function() {
    describe('#value', function() {
      it('should use the value attribute when available', function() {
        const el = helpers.build(window.__html__['Coral.ButtonGroup.selectionMode.single.selected.html']);
        var items = el.items.getAll();
      ...
      it('should default to the text when value attribute is not available', function() {
        const el = helpers.build(window.__html__['Coral.ButtonGroup.selectionMode.single.novalues.html']);
        var items = el.items.getAll();
    ...
    describe('#values', function() {
      ...
      it('should reject multiple "selected" items', function() {
        const el = helpers.build(window.__html__['Coral.ButtonGroup.selectionMode.single.doubleselected.html']);
        var items = el.items.getAll();
      ...
      it('should select all items with "selected" attribute when selectionMode is "multiple"', function() {
        const el = helpers.build(window.__html__['Coral.ButtonGroup.selectionMode.multiple.selected.html']);
        var selectedButtons = el.querySelectorAll('button[is=coral-button][selected]');
    ...
    describe('#reset()', function() {
      it('initial items without an explicit value should get a valid value from the textContent', function() {
        const el = helpers.build(window.__html__['Coral.ButtonGroup.selectionMode.multiple.novalues.html']);
        var items = el.items.getAll();
  ...
  describe('Events', function() {
    describe('#change', function() {
      it('should not trigger change while setting values programatically', function() {
        ...
        const el = helpers.build(window.__html__['Coral.ButtonGroup.base.html']);
      ...
      it('should trigger change when unselected buttons are clicked and selectionMode = multiple', function() {
        ...
        const el = helpers.build(window.__html__['Coral.ButtonGroup.selectionMode.multiple.html']);
        // adds the required listeners
        el.on('change', changeSpy);
