...
(function() {
  ...
  Coral.register( /** @lends Coral.List */ {
    ...
    */
    ...
    events: {
      'capture:mouseenter [coral-list-item]': '_handleItemMouseEnter',
    ...
    */
    ...
    _handleItemMouseEnter: function(event) {
      // Don't try to focus on disabled items
      if (!event.matchedTarget.hasAttribute('disabled')) {
  ...
  Coral.register( /** @lends Coral.List.Item */ {
    ...
    */
    ...
    _render: function() {
      ...
      var content = this._elements.content = this.querySelector('coral-list-item-content') || document.createElement('coral-list-item-content');
  ...
  Coral.register( /** @lends Coral.Autocomplete# */ {
    ...
    */
    ...
    events: {
      ...
      'key:shift+tab coral-list-item': '_handleListFocusShift',
    ...
    */
    ...
    _focusFirstItem: function() {
      ...
      var item = selectList.items.first();
      if (item) {
        Coral.commons.nextFrame(function() {
          item.focus();
        });
    ...
    _handleInputBlur: function(event) {
      ...
      setTimeout(function() {
        ...
        if (!self.contains(relatedTarget)) {
...
this["Coral"]["templates"]["Autocomplete"]["loadIndicator"] = (function anonymous(data_0
/**/) {
    var frag = document.createDocumentFragment();
    var data = data_0;
    var el0 = document.createElement("div");
  ...
  Coral.register( /* @lends Coral.Clock# */ {
    ...
    properties: {
      ...
      'value': {
        ...
        set: function(value) {
          ...
          var time = moment(value, ['HH:mm', 'H:mm'], true);
    ...
    */
    _onInputKeyPress: function(event) {
      var newValue = event.target.value + String.fromCharCode(event.keyCode);
...
this["Coral"] = this["Coral"] || {};
this["Coral"]["templates"] = this["Coral"]["templates"] || {};
this["Coral"]["templates"]["CycleButton"] = this["Coral"]["templates"]["CycleButton"] || {};
this["Coral"]["templates"]["CycleButton"]["base"] = (function anonymous(data_0
/**/) {
  var frag = document.createDocumentFragment();
  var data = data_0;
  var el0 = this["button"] = document.createElement("button","coral-button");
...
(function() {
  ...
  Coral.register( /** @lends Coral.NumberInput# */ {
    ...
    */
    _onInputKeyPress: function(event) {
      var newValue = this.value + String.fromCharCode(event.keyCode);
      if (newValue !== newValue.replace(REG_EXP, '')) {
        event.preventDefault();
      }
    },
    ...
    */
    ...
    _onLayout: function() {
      ...
      if (focusedItem && focusedItem.hasAttribute && focusedItem.hasAttribute('coral-actionbar-offscreen')) {
        ...
        // algorithm possible
        Coral.ActionBar._getFirstSelectableWrappedItem(this._getAllSelectableItems()[0]).focus();
      }
    },
