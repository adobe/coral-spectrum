...
(function ($) {
  ...
  $(function () {
    ...
    }).on('click.popover.data-api', '[data-toggle="popover"]', function (ev) {
      ev.preventDefault();
    });
  });
}(window.jQuery));
...
(function ($) {
  ...
  CUI.Datepicker = new Class(/** @lends CUI.Datepicker# */{
    ...
    _adjustMarkup: function () {
      var $element = this.$element;
      $element.addClass("coral-DatePicker");
...
(function ($, window, undefined) {
  CUI.Autocomplete = new Class(/** @lends CUI.Autocomplete# */{
    ...
    construct: function () {
      ...
      this._inputGroup = this.$element.find('.js-coral-Autocomplete-inputGroup');
    ...
    getValue: function () {
      if (this.options.multiple) { // multiple returns array
        ...
        var type = this._selectListWidget.get('type');
    ...
    _setSelectlist: function () {
      ...
      this._selectlist.selectList($.extend({
        relatedElement: this._inputGroup,
        autofocus: false,
        autohide: true
      }, this.options.selectlistConfig || {}));
    ...
    _handleSelected: function (event) {
      ...
      if (this.options.multiple) {
        ...
        this._lastSelected = selectedValue;
  ...
  CUI.Accordion = new Class(/** @lends CUI.Accordion# */{
    ...
    _setAccordion: function () {
      ...
      if (this.isAccordion) {
        ...
        var activeIndex = $element.children(".is-active").index();
        if (this.options.active !== false) activeIndex = this.options.active;
        $element.children().each(function (index, element) {
          this._initElement(element, index != activeIndex);
        }.bind(this));
      } else {
        this._initElement($element, !(this.options.active || $element.hasClass("is-active")));
      }
    ...
    _collapse: function (el) {
      this._getHeaderIconElement(el).removeClass(this.options.iconClassExpanded).addClass(this.options.iconClassCollapsed);
    ...
    _expand: function (el) {
      ...
      this._getHeaderIconElement(el).removeClass(this.options.iconClassCollapsed).addClass(this.options.iconClassExpanded);
