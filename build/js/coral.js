  ...
  Coral.register( /* @lends Coral.Calendar# */ {
    ...
    properties: {
      ...
      */
      'valueAsDate': {
        ...
        get: function() {
          return this._date ? this._date.toDate() : null;
        },
        set: function(value) {
          this._setDate(value);
        },
    ...
    */
    ...
    _renderTable: function(year, month) {
      ...
      var dateLocal = this._date ? this._date.clone().startOf('day') : null;
    ...
    _requireCursor: function() {
      ...
      if (!cursor || !cursor.isValid()) {
        ...
        cursor = (this._date ? this._date.clone().startOf('day') : moment()).startOf('month');
        this._cursor = cursor;
      }
    ...
    _setInputValue: function() {
      this._elements.input.value = this._date ? this._date.format(this.valueFormat) : '';
    }
  });
}());
  ...
  Coral.register( /* @lends Coral.Datepicker# */ {
    ...
    properties: {
      ...
      */
      'valueAsDate': {
        ...
        get: function() {
          return (this._value && this._value.isValid()) ? this._value.clone().toDate() : null;
        },
        set: function(value) {
          this.value = value;
        }
      ...
      */
      'value': {
        ...
        set: function(value) {
          this._value = moment(value, this.valueFormat);
    ...
    */
    ...
    _onCalendarDayClick: function() {
      // if the user has selected the same date as the previously selected one close the popover
      if (this._value.isSame(this._mergeCalendarAndClockDates())) {
    ...
    _onInputChange: function(event) {
      ...
      var val = moment(value, this.displayFormat);
      if (val) {
        this.value = val;
      }
  ...
  Coral.register( /** @lends Coral.StepList# */ {
    ...
    */
    ...
    events: {
      ...
      'focusin > coral-step': '_onStepMarkerMouseEnter',
      'capture:mouseenter > coral-step': '_onStepMarkerMouseEnter',
      'focusout > coral-step': '_onStepMarkerMouseLeave',
