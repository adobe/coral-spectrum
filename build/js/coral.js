    ...
    */
    ...
    properties: {
      ...
      */
      ...
      /**
        The minimal selectable date in the Calendar view. When passed a string, it needs to be 'YYYY-MM-DD'
        formatted.
  ...
  */
  ...
  Coral.register( /* @lends Coral.Datepicker# */ {
    ...
    */
    ...
    /** @ignore */
    _onInputChange: function(event) {
      // because we are reimplementing the form field mix in,
      // we will have to stop the propagation and trigger the 'change' event from here
      event.stopPropagation();
    ...
    /**
      Utility returning the value as a String formatter in accordance to the passed format string. Returns an
