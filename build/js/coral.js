...
(function() {
  ...
  */
  Coral.Component.prototype.trigger = function(eventName, props, bubbles, cancelable) {
    ...
    // Trigger the event and store its return value
  ...
  */
  ...
  /**
    Triggerred after the component is hidden with {@link Coral.Component#hide}.

    @event Coral.Component#coral-component:hide
...
this["Coral"]["templates"]["Alert"]["icon"] = (function anonymous(data_0) {
  ...
  el0.className += " coral-Alert-typeIcon";
  ...
  */
  ...
  Coral.register( /** @lends Coral.SelectList.Item# */ {
    ...
    */
    ...
    className: 'coral-SelectList-item',
...
(function() {
  ...
  AutocompleteCollection.prototype.add = function(item, insertBefore) {
    ...
    this._host.insertBefore(item, insertBefore);
    return item;
  };
    ...
    */
    _handleSelect: function(event) {
      ...
      if (!this.multiple) {
        ...
        this._setInputValues(this.value, selectListItem.content);
      }
      else {
        // Add to values
...
this["$"+"trigger"] = $(el13);
  ...
  el13.setAttribute("variant", "secondary");
...
this["Coral"]["templates"]["Dialog"]["header"] = (function anonymous(data_0) {
  ...
  el5.className += " coral-Dialog-closeButton";
  el5.setAttribute("variant", "minimal");
  el5.setAttribute("aria-label", "Close");
  el5.setAttribute("coral-close", "");
  var el6 = document.createTextNode("\n  ");
  el5.appendChild(el6);
  var el7 = document.createElement("i");
  el7.className += " coral-Icon coral-Icon--sizeXS coral-Icon--close";
  el5.appendChild(el7);
  var el8 = document.createTextNode("\n");
  el5.appendChild(el8);
  frag.appendChild(el5);
  ...
  Coral.register( /** @lends Coral.Popover# */ {
    ...
    */
    ...
    events: {
      ...
      'global:touchstart': '_handleClick',
    ...
    */
    ...
    _render: function() {
      ...
      contentWrapper.className = 'coral-Popover-content';
...
(function() {
  ...
  function parseTime(value) {
    ...
    if (value && value.match) {
      var time = value.match(TIME_REGEX);
      if (time) {
        var result = new Date();
        result.setHours(parseInt(time[1], 10) + (time[3] ? 12 : 0));
        result.setMinutes(parseInt(time[2], 10) || 0);
        return result;
      }
    }
  ...
  Coral.register( /* @lends Coral.Clock# */ {
    ...
    */
    ...
    properties: {
      ...
      'value': {
        get: function() {
          return this._time ? this._time.toTimeString().substr(0, 5) : null;
        },
        set: function(value) {
          this._setTime(parseTime(value));
        },
        sync: function() {},
        alsoSync: ['_renderClockFlag', 'required']
      },
      ...
      */
      'valueAsDate': {
        ...
        get: function() {
          return this._time ? new Date(this._time.getTime()) : null;
        },
        set: function(value) {
          this._setTime(value);
        },
      ...
      '_renderClockFlag': {
        sync: function() {
          this._selectListItem(
            ...
            this._time ? this._time.getHours() : -1
          );
          this._selectListItem(
            this._elements.minutes,
            this._time ? this._time.getMinutes() : -1
          );
        }
      }
    },
    ...
    /**
      Internal keeper of the selected time (as a Date). Getters 'value' and 'valueAsDate' reflect this value.
    ...
    */
    ...
    attachedCallback: function() {
      ...
      if (!this._boundClientChangeHandler) {
        this._boundClientChangeHandler = this._clientChangeHandler.bind(this);
      }

      this._elements.hours.on('change', this._boundClientChangeHandler);
      this._elements.minutes.on('change', this._boundClientChangeHandler);
    },

    /** @ignore */
    detachedCallback: function() {
      this._elements.hours.off('change', this._boundClientChangeHandler);
      this._elements.hours.off('change', this._boundClientChangeHandler);
    ...
    /** @ignore */
    _render: function() {
      var fragment = Coral.templates.Clock.clock.call(this._elements);
      this.appendChild(fragment);
    },
    ...
    _setTime: function(value) {
      ...
      if (
        !this._time || !value ||
        this._time.getHours() !== value.getHours() ||
        this._time.getMinutes() !== value.getMinutes()
      ) {
        if (this._time !== value) {
          this._time = value;
          this._setInputValue();
    ...
    /** @ignore */
    _setInputValue: function() {
      this._elements.input.value = this._time ?
        this._time.toTimeString().substr(0, 5) :
        '';
    },

    /** @ignore */
    _clientChangeHandler: function(event) {
      event.stopPropagation();
...
this["Coral"]["templates"]["Clock"]["clock"] = (function anonymous(data_0) {
  var frag = document.createDocumentFragment();
  var data = data_0 = typeof data_0 === "undefined" ? {} : data_0;
  var el0 = this["input"] = document.createElement("input");
  el0.setAttribute("handle", "input");
  ...
  el2.className += " coral-Icon coral-Icon--clock coral-Icon--small";
  frag.appendChild(el2);
  var el3 = document.createTextNode("\n");
  frag.appendChild(el3);
  ...
  el15.setAttribute("style", "position: relative;");
  var el16 = document.createTextNode("\n  ");
  ...
  Coral.register( /* @lends Coral.Datepicker# */ {
    ...
    properties: {
      ...
      */
      'type': {
        ...
        sync: function() {
          ...
          this._elements.clock.style.display = this.type !== type.DATE ? 'block' : 'none';
          this._elements.calendar.style.display = this.type === type.TIME ? 'none' : 'block';
        },
        alsoSync: ['_useNativeInput']
      },

      /**
        The format to use on expressing the selected date(time) as a string on the user facing input, as well as on
        parsing input entered by the user manually. The default value depends on <code>type</code>, being either
        <code>YYYY-MM-DD[T]HH:mmZ</code>, <code>YYYY-MM-DD</code>, <code>HH:mm</code>, or
        <code>YYYY-MM-DD[T]HH:mm</code>. See http://momentjs.com/docs/#/displaying/ for valid format string options.
      ...
      */
      'displayFormat': {
        ...
        get: function() {
          return this._useNativeInput ? NATIVE_FORMATS[this.type] : this._displayFormat;
        }
      },
      ...
      /**
        ...
        See {@link Coral.Calendar#valueFormat}
      ...
      */
      'valueFormat': {
        ...
        get: function() {
          return this._elements.calendar.valueFormat;
        },
        set: function(value) {
      ...
      */
      'valueAsDate': {
        ...
        get: function() {
          return (this._innerValue && this._innerValue.isValid()) ?
            this._innerValue.clone().toDate() :
            null;
        },
        set: function(value) {
          this._innerValue = moment(value);
        }
      },
      ...
      */
      ...
      'name': {
        set: function(value) {
          this._elements.hiddeninput.setAttribute('name', value);
        },
        get: function(value) {
          return this._elements.hiddeninput.getAttribute('name');
        }
      },
      ...
      '_useNativeInput': {
        sync: function() {
          if (this._useNativeInput) {
            ...
            this.setAttribute('aria-haspopup', 'true');
            this.setAttribute('aria-expanded', 'false');
            this.setAttribute('aria-owns', this._elements.calendar.id);
          }
        }
      },
    ...
    */
    ...
    _render: function() {
      ...
      // Popover isn't friendly about rendering itself correctly if it has elements inside of it
      // So we'll create the calendar and the clock at render time
      this._elements.calendar = new Coral.Calendar().set({
        borderless: true,
        id: Coral.commons.getUID()
      });

      this._elements.clock = new Coral.Clock();

      // Add the calendar to the popover
      // This is dirty, but it works until popover accepts a DOM element as content
      var popoverContent = this._elements.popover.querySelector('coral-popover-content');
      popoverContent.appendChild(this._elements.calendar);
      popoverContent.appendChild(this._elements.clock);

      // Configure the popover
      this._elements.popover.set({
        // Point at the button from the bottom
        target: this._elements.toggle,
    ...
    _mergeCalendarAndClockDates: function() {
      var value = moment(this._elements.calendar._date);
    ...
    /**
      Utility returning the inner value as a string formatted in accordance to the passed format string. Returns
      <code>null</code> when <code>_innerValue</code> is <code>null</code> or not a valid moment.
...
this["Coral"]["templates"]["Datepicker"]["base"] = (function anonymous(data_0) {
  ...
  frag.appendChild(el1);
  var el2 = document.createElement("div");
  el2.className += " coral-InputGroup";
  var el3 = document.createTextNode("\n  ");
  el2.appendChild(el3);
  ...
  var el11 = this["toggle"] = document.createElement("button","coral-button");
  el11.setAttribute("is", "coral-button");
  el11.setAttribute("type", "button");
  el11.setAttribute("icon", "calendar");
  el11.setAttribute("iconsize", "S");
  el11.setAttribute("variant", "secondary");
  el11.setAttribute("handle", "toggle");
  ...
  var el14 = document.createTextNode("\n");
  frag.appendChild(el14);
  var el15 = this["hiddeninput"] = document.createElement("input");
  el15.setAttribute("type", "hidden");
  el15.setAttribute("handle", "hiddeninput");
  frag.appendChild(el15);
  var el16 = document.createTextNode("\n");
  frag.appendChild(el16);
  return frag;
...
this["Coral"]["templates"]["NumberInput"]["base"] = (function anonymous(data_0) {
  ...
  el4.setAttribute("variant", "secondary");
  ...
  Coral.register( /** @lends Coral.Slider# */ {
    ...
    */
    _onMouseDown: function(event) {
      ...
      if (this.tooltips) {
        ...
        this._openTooltip(this._currentHandle, this._getLabel(this.values[idx]));
      }
    ...
    */
    ...
    /**
      ...
      based on the data in this.values
    ...
    */
    _moveHandles: function() {
      ...
      this._elements.$handles.each(function(index, handle) {
        var $handle = $(handle),
          percent = calculatePercent(self.values[index]);
        ...
        self._updateTooltip($handle, self._getLabel(self.values[index]));
      });
    },
    ...
    _focus: function(event) {
      ...
      if (this.tooltips) {
        this._openTooltip($handle, self._getLabel(self.values[index]));
      }
    ...
    */
    ...
    _onMouseEnter: function(event) {
      ...
      if (this.tooltips) {
        this._openTooltip($handle, this._getLabel(this.values[index]));
      }
    },
    ...
    */
    ...
    _updateFill: function() {
      var percent = ((this.values[0] - this.min) / (this.max - this.min)) * 100;
