...
(function ($) {
  CUI.Accordion = new Class(/** @lends CUI.Accordion# */{
    ...
    _setListeners: function () {
      var selector = this.isAccordion ? '> .coral-Collapsible > .coral-Accordion-header' : '> .coral-Collapsible-header';
    ...
    _makeAccessible: function () {
      ...
      if (this.isAccordion) {
        ...
        this.$element.children(".coral-Collapsible").each(function (i, e) {
          var section = $(e),
            head = section.find("> .coral-Accordion-header:first"),
        ...
        case 38: //up arrow
          if ((isHead && this.isAccordion) || (event.which === 33 && (event.metaKey || event.ctrlKey))) {
            ...
            if (this._getHeaderFirstElement(el.prev()).focus().length === 0) {
              this.$element.find("> .coral-Collapsible:last > .coral-Accordion-header:first").focus();
            }
        ...
        case 40: //down arrow
          if (isHead && this.isAccordion) {
            ...
            if (this._getHeaderFirstElement(el.next()).focus().length === 0) {
               this.$element.find("> .coral-Collapsible:first > .coral-Accordion-header:first").focus();
            }
    ...
    _onFocusIn: function (event) {
      ...
      if (isHead) {
        if (this.isAccordion) {
          this.$element.find("> .coral-Collapsible > .coral-Accordion-header[role=tab]").attr('tabindex', -1);
        }
