...
<html lang="en">
<head>
    <title>Code coverage report for coralui-component-modal/node_modules/coralui-component-alert/build/js/CUI.Alert.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">coralui-component-modal/node_modules/coralui-component-alert/build/js/CUI.Alert.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">coralui-component-modal/node_modules/coralui-component-alert/build/js/</a> &#187; CUI.Alert.js</div>
</div>
<div class="body">
...
&nbsp;
      for (var sizeKey in this._sizes) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.$element.hasClass(this._sizes[sizeKey])) {
<span class="cstat-no" title="statement not covered" >          this.options.size = sizeKey;</span>
...
&nbsp;
    ...
    _setCloseable: function () {
      ...
      if (!el.length &amp;&amp; this.options.closeable) {
        ...
        el[this.options.closeable ? <span class="branch-0 cbranch-no" title="branch not covered" >'show' </span>: 'hide']();
      }
    },
&nbsp;
    /** @ignore */
...
&nbsp;
    /** @ignore */
    _fixType: <span class="fstat-no" title="function not covered" >function (value) {</span>
<span class="cstat-no" title="statement not covered" >      return this._isValidType(value) ? value : this.defaults.type;</span>
    },
&nbsp;
    /** @ignore */
    _fixHeading: <span class="fstat-no" title="function not covered" >function (value) {</span>
<span class="cstat-no" title="statement not covered" >      return value === undefined ? this._fixType(this.options.type).toUpperCase() : value;</span>
    }
&nbsp;
  });
&nbsp;
...
&nbsp;
  // Data API
  <span class="missing-if-branch" title="else path not taken" >E</span>if (CUI.options.dataAPI) {
    $(function () {
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Tue Apr 29 2014 12:01:23 GMT+0200 (CEST)</div>
</div>
