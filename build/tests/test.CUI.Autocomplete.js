describe('CUI.Autocomplete', function () {
  ...
  beforeEach(function () {
    var autocompleteHtml = '' +
      '<span class="coral-Autocomplete" data-init="autocomplete" data-multiple="true">' +
      '  <i class="coral-Autocomplete-icon coral-Icon coral-Icon--search coral-Icon--sizeXS"></i>' +
      '  <input class="coral-Textfield coral-Autocomplete-textfield" type="text" name="name1" placeholder="Search">' +
      '  <button type="button" class="coral-MinimalButton coral-Autocomplete-toggleButton"></button>' +
    ...
    $input = $autocomplete.find('.coral-Autocomplete-textfield');
    $toggle = $autocomplete.find('.coral-Autocomplete-toggleButton');
    $selectList = $autocomplete.find('.coral-SelectList');
    $tagList = $autocomplete.find('.coral-TagList');
  });
