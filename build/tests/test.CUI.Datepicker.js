describe('CUI.Datepicker', function() {
    ...
    describe("with different week configurations", function() {
          ...
          it('should open a picker with configured day as first day of week', function(done) {
            ...
            setTimeout(function() {
                expect($("body").find("#popguid2.coral-DatePicker-popover").find(".coral-DatePicker-calendarBody table tr th:eq(0)").text()).to.equal("Tu");
                done();
              }, 200);
          });
    });
    ...
    describe("as a time field", function() {
          ...
          it('should not have a calendar popup', function(done) {
            ...
            // spawning of the actual pop-up:
            setTimeout(function() {
                expect($("body").find("#popguid3.coral-DatePicker-popover").find(".coral-DatePicker-calendarBody").length).to.equal(0);
                done();
              }, 200);
          });
    });
