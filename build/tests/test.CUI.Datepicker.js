describe('CUI.Datepicker', function() {
    ...
    describe("from markup", function() {
        it('should be a datepicker', function() {
            ...
            expect(el).to.have.class("coral-DatePicker");
        });
    });

    describe("with different date formats", function() {
        var html = '' +
            '<div class="coral-DatePicker coral-InputGroup" data-stored-format="DD..MM..YYYY" data-displayed-format="DD MM YYYY">' +
    ...
    describe("with different week configurations", function() {
          var html = '' +
              '<div class="coral-DatePicker coral-InputGroup" data-displayed-format="DD. MM. YYYY" data-start-day="2">' +
