    ...
    describe('API', function() {
      ...
      describe('#disabled', function() {
        ...
        it('should default to false', function() {
            expect(datepicker.get('disabled')).to.be.false;
            expect(el.find('input').attr('disabled')).to.be.undefined;
            expect(el.find('button').attr('disabled')).to.be.undefined;
        });

        it('should be settable during runtime', function() {
            datepicker.set('disabled', true);

            expect(datepicker.get('disabled')).to.be.true;
            expect(el.find('input').attr('disabled')).to.equal('disabled');
            expect(el.find('button').attr('disabled')).to.equal('disabled');
        });
      });
    });
