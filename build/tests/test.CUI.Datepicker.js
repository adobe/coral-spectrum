describe('CUI.Datepicker', function() {
    ...
    describe("with different date formats", function() {
        var html = '' +
            '<div class="coral-DatePicker" data-stored-format="DD..MM..YYYY" data-displayed-format="DD MM YYYY">' +
    ...
    describe("with different week configurations", function() {
          var html = '' +
              '<div class="coral-DatePicker" data-displayed-format="DD. MM. YYYY" data-start-day="2">' +
              '  <div class="coral-InputGroup">' +
