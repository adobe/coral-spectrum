describe('CUI.Select', function() {
  ...
  describe('setValue', function() {
    it('should set an option as selected when not using groups', function() {
      var select = $(singleSelectMarkup).select().data('select');
      select.setValue('3');
      expect(select.getValue()).to.equal('3');
    });

    it('should set an option as selected when using groups', function() {
      var select = $(optGroupMarkup).select().data('select');
      select.setValue('3');
      expect(select.getValue()).to.equal('3');
    });
  });
