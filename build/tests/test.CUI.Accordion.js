describe('CUI.Accordion', function () {
  ...
  describe('user interaction', function () {
    ...
    it('should collapse expanded collapsible in accordion when header is clicked', function () {
    ...
    it('should collapse markup-expanded collapsible in accordion when header is clicked', function () {
      var el = $(ACCORDION_HTML).appendTo('body');
    ...
    it('should collapse expanded collapsible when header is clicked', function () {
    ...
    it('should collapse markup-expanded collapsible when header is clicked', function () {
