  ...
  describe('testFormField', function() {
    ...
    describe('API', function() {
      ...
      describe('#value', function() {
        ...
        it('should have the correct default', function(done) {
          ...
          // due to mutation observers that detect the attribute removal
        ...
        it('should not be reflected', function(done) {
      ...
      describe('#name', function() {
        ...
        it('should be set synchronously', function() {
          var namedItems = el.$.filter('[name]');
          namedItems.each(function() {
            expect(this.name).to.equal('', 'Internal name must be empty');
          });
          ...
          expect(el.$.filter('[name="componentName"]').length).to.equal(1, 'Only one element has the provided name');
          expect(el.name).to.equal('componentName');
        });

        it('should not submit a value when the name is not specified even though there is a value', function(done) {
        ...
        it('should submit the one single value', function(done) {
          ...
          helpers.next(function() {
            ...
            // We need to wait one frame as Coral.Select only updates its native select asynchronously
            helpers.next(function() {
              if (options.value !== '') {
                // we check value immediately to make sure it is set without delay
                expect(el.$.parent().serializeArray()[0]).to.deep.equal({
                  name: 'componentName',
                  value: options.value
                });
              }
      ...
      describe('#invalid', function() {
        ...
        it('should be settable programatically', function() {
          el.invalid = true;
      ...
      describe('#labelledBy', function() {
        it('should remove labels with empty string', function() {
          ...
          if ($(labelledElement).is(LABELLABLE_ELEMENTS_SELECTOR)) {
      ...
      describe('#reset()', function() {
        ...
        it('should be called when form is reset programatically', function(done) {
        ...
        it('should be called when form is reset via reset input', function(done) {
          var initialValue = el.value;
    ...
    describe('Events', function() {
      describe('#change', function() {
        it('should not be trigged when setting the value programatically', function() {
