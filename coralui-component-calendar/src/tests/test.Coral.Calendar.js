...
describe('Coral.Calendar', function() {
  ...
  describe('Instantiation', function() {
    it('should be possible to clone the element using markup', function() {
      const el = helpers.build(window.__html__['Coral.Calendar.base.html']);
      helpers.cloneComponent(el);
    });
    
    it('should be possible to clone the element using markup with a value', function() {
      const el = helpers.build(window.__html__['Coral.Calendar.value.html']);
      helpers.cloneComponent(el);
    });
    
    it('should be possible via cloneNode using js', function() {
      helpers.cloneComponent(new Coral.Calendar());
    });
  });
  ...
  for (let useMomentJS = 0; useMomentJS < 2; useMomentJS++) {
    ...
    describe('Markup', function() {
      describe('#min', function() {
        ...
        it('should accept valid dates as string', function() {
          const el = helpers.build(window.__html__['Coral.Calendar.min.html']);
        ...
        it('should set invalid values to null', function() {
          const el = helpers.build(window.__html__['Coral.Calendar.min.invalid.html']);
      ...
      describe('#max', function() {
        ...
        it('should accept valid dates as string', function() {
          const el = helpers.build(window.__html__['Coral.Calendar.max.html']);
        ...
        it('should set invalid values to null', function() {
          const el = helpers.build(window.__html__['Coral.Calendar.max.invalid.html']);
    ...
    describe('User Interaction', function() {
      ...
      beforeEach(function() {
        el = helpers.build(new Coral.Calendar());
      });
