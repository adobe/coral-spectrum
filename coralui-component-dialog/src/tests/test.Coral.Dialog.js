describe('Coral.Dialog', function() {
  ...
  describe('API', function() {
    ...
    beforeEach(function() {
      el = helpers.build(new Coral.Dialog());
    });
  ...
  describe('Markup', function() {
    ...
    it('should not focus the close button', function(done) {
      const el = helpers.build(window.__html__['Coral.Dialog.closable.html']);
  ...
  describe('User Interaction', function() {
    describe('#ESC', function() {
      it('should close when escape pressed and interaction=ON', function() {
        const el = helpers.build(window.__html__['Coral.Dialog.open.html']);
        expect(el.open).to.be.true;
    ...
    describe('[coral-close]', function() {
      it('should close when close button clicked', function() {
        const el = helpers.build(window.__html__['Coral.Dialog.full.html']);
  ...
  describe('Implementation details', function() {
    ...
    describe('Backdrop', function() {
      ...
      it('should support inner-wrapper elements', function() {
        el = helpers.build(window.__html__['Coral.Dialog.wrapper.multiple.html']);
