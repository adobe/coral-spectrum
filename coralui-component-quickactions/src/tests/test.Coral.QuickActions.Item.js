describe('Coral.QuickActions.Item', function() {
  ...
  beforeEach(function() {
    item = helpers.build(new Coral.QuickActions.Item());
  });
  ...
  describe('Instantiation', function() {
    ...
    it('should be possible to clone using js', function() {
      helpers.cloneComponent(new Coral.QuickActions.Item());
    });
  });
  ...
  describe('API', function() {
    ...
    describe('#type', function() {
      ...
      it('should be reflected to the DOM', function() {
        item.type = Coral.QuickActions.Item.type.ANCHOR;
        expect(item.getAttribute('type')).to.equal(Coral.QuickActions.Item.type.ANCHOR, 'type should be reflected');
      });
    });
  });
