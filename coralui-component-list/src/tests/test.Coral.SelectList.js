describe('Coral.SelectList', function() {
  ...
  describe('Instantiation', function() {
    ...
    it('should be possible using new', function() {
      var el = helpers.build(new Coral.SelectList());
    ...
    it('should be possible to clone using markup', function() {
      helpers.cloneComponent(helpers.build(window.__html__['Coral.SelectList.base.html']));
    });
  
    it('should be possible to clone using markup with groups', function() {
      helpers.cloneComponent(helpers.build(window.__html__['Coral.SelectList.groups.html']));
    });

    it('should be possible to clone using js', function() {
      const el = new Coral.SelectList();
      el.items.add({
        content: {
          innerHTML: 'Item 1'
        }
  ...
  describe('API', function() {
    ...
    beforeEach(function() {
      ...
      item = new Coral.SelectList.Item();
      group = new Coral.SelectList.Group();
    });
  ...
  describe('Markup', function() {
    ...
    describe('#selectedItem', function() {
      ...
      it('should take the last selected if not multiple', function() {
        helpers.target.innerHTML = window.__html__['Coral.SelectList.doubleselected.html'];
      ...
      it('should take the first selected with multiple', function() {
        helpers.target.innerHTML = (window.__html__['Coral.SelectList.multiple.html']);
        const el = document.querySelector('coral-selectlist');
        var items = el.items.getAll();
    ...
    describe('#groups', function() {
      ...
      beforeEach(function() {
        el = helpers.build(window.__html__['Coral.SelectList.groups.html']);
      });
  ...
  describe('Events', function() {
    ...
    beforeEach(function() {
      el = helpers.build(new Coral.SelectList());
    ...
    describe('#coral-selectlist:scrollbottom', function() {
      ...
      it('should trigger a scrollbottom event when user scrolls to the bottom of the list', function() {
        const el = helpers.build(new Coral.SelectList());
        for (var i = 0; i < 50; i++) {
          el.items.add({
            value: 'value' + i,
            content: {
