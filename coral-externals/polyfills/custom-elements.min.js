...
//           c = e.import;
//           if (c instanceof Node && !d.has(c)) for (d.add(c), c = c.firstChild ; c ; c = c.nextSibling) n(c, a, d);
//           c = m(b, e);
//           continue
//         } else if ("template" === h) {
//           c = m(b, e);
//           continue
//         }
//         if (e = e.__CE_shadowRoot) for (e = e.firstChild ; e ; e = e.nextSibling) n(e, a, d)
//       }
...
//       a.__CE_patched = !0;
//       for (var d = 0 ; d < b.m.length ; d++) b.m[d](a)
//     }
//   }
//
//   function x(b, a) {
...
//       }
//     }, d);
//     if (b.b) for (a = 0 ; a < c.length ; a++) w(b,
//       c[a]);
...
//           var e = d[c], h = a.getAttribute(e);
//           null !== h &&
//           b.attributeChangedCallback(a, e, null, h, null)
//         }
...
//     for (a = 0 ; a < b.length ; a++) for (var d = b[a].addedNodes, c = 0 ; c < d.length ; c++) A(this.c, d[c])
//   };
//
//   function ca() {
//     var b = this;
...
//   var F = window.Document.prototype.createElement, da = window.Document.prototype.createElementNS,
//     ea = window.Document.prototype.importNode, fa = window.Document.prototype.prepend,
//     ga = window.Document.prototype.append, G = window.Node.prototype.cloneNode, H = window.Node.prototype.appendChild,
//     I = window.Node.prototype.insertBefore, J = window.Node.prototype.removeChild,
//     K = window.Node.prototype.replaceChild, L = Object.getOwnPropertyDescriptor(window.Node.prototype, "textContent"),
//     M = window.Element.prototype.attachShadow, N = Object.getOwnPropertyDescriptor(window.Element.prototype,
//     "innerHTML"), O = window.Element.prototype.getAttribute, R = window.Element.prototype.setAttribute,
//     S = window.Element.prototype.removeAttribute, T = window.Element.prototype.getAttributeNS,
//     U = window.Element.prototype.setAttributeNS, V = window.Element.prototype.removeAttributeNS,
//     W = window.Element.prototype.insertAdjacentElement, ha = window.Element.prototype.prepend,
//     ia = window.Element.prototype.append, ja = window.Element.prototype.before, ka = window.Element.prototype.after,
//     la = window.Element.prototype.replaceWith, ma = window.Element.prototype.remove,
//     na = window.HTMLElement, X = Object.getOwnPropertyDescriptor(window.HTMLElement.prototype, "innerHTML"),
//     oa = window.HTMLElement.prototype.insertAdjacentElement, pa = {
...
//       e && (window[a] = function () {
//         function d() {
//           var e = this.constructor, d = b.f.get(e);
...
//     }
//
//     for (var d in pa) a("HTML" + d + "Element", pa[d])
//   };
//
//   function sa(b, a, d) {
...
//       if (l(this)) for (c = 0 ; c < e.length ; c++) f = e[c], f instanceof Element && x(b, f)
//     };
//     a.append = function (a) {
//       for (var e = [], c = 0 ; c < arguments.length ; ++c) e[c - 0] = arguments[c];
//       c = e.filter(function (b) {
...
//       for (var f = 0 ; f < c.length ; f++) z(b, c[f]);
//       if (l(this)) for (c = 0 ; c <
//       e.length ; c++) f = e[c], f instanceof Element && x(b, f)
//     }
//   };
//
//   function ta() {
...
//       return a
//     });
//     sa(b, Document.prototype, {o: fa, append: ga})
//   };
//
//   function ua() {
//     var b = Y;
...
//             var e = void 0;
//             if (this.firstChild) {
//               var d = this.childNodes, u = d.length;
//               if (0 < u && l(this)) for (var e = Array(u), t = 0 ; t < u ; t++) e[t] = d[t]
//             }
//             c.set.call(this, a);
//             if (e) for (a = 0 ; a < e.length ; a++) z(b, e[a])
//           }
//         }
//       })
//     }
...
//         return a
//       }
//       var e = l(a), d = K.call(this, a, c), f = l(this);
//       f && z(b, c);
//       e && z(b, a);
//       f && x(b, a);
//       return d
...
//           for (var a = [], b =
//             0 ; b < this.childNodes.length ; b++) a.push(this.childNodes[b].textContent);
//           return a.join("")
//         }, set: function (a) {
...
//       });
//       ja.apply(this, c);
//       for (var d = 0 ; d < e.length ; d++) z(b, e[d]);
//       if (l(this)) for (e = 0 ; e < c.length ; e++) d = c[e], d instanceof Element && x(b, d)
//     };
//     a.after = function (a) {
//       for (var c = [], e = 0 ; e < arguments.length ; ++e) c[e - 0] = arguments[e];
//       e = c.filter(function (a) {
...
//       for (var d = 0 ; d < e.length ; d++) z(b, e[d]);
//       if (l(this)) for (e =
//                           0 ; e < c.length ; e++) d = c[e], d instanceof Element && x(b, d)
//     };
...
//       }), d = l(this);
//       la.apply(this, c);
//       for (var f = 0 ; f < e.length ; f++) z(b, e[f]);
//       if (d) for (z(b, this), e = 0 ; e < c.length ; e++) d = c[e], d instanceof Element && x(b, d)
//     };
//     a.remove = function () {
//       var a = l(this);
//       ma.call(this);
...
//             for (c.innerHTML = a ; 0 < b.childNodes.length ;) J.call(b,
//               b.childNodes[0]);
...
//     });
//     p(Element.prototype, "removeAttribute",
//       function (a) {
...
//     sa(b, Element.prototype, {o: ha, append: ia});
//     va(b)
//   };/*
//
