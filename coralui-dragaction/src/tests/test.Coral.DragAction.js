describe('Coral.DragAction', function() {
  ...
  describe('Instantiation', function() {
    ...
    it('should initialize an instance of Coral.DragAction', function() {
      var dragElement = helpers.build(window.__html__['Coral.DragAction.base.html']);
    ...
    it('should destroy the Coral.DragAction instance', function() {
      var dragElement = helpers.build(window.__html__['Coral.DragAction.base.html']);
  ...
  describe('Markup', function() {
    ...
    describe('#dropZone', function() {
      ...
      it('should set a DOM dropZone', function() {
        var dragElement = helpers.build(window.__html__['Coral.DragAction.base.html']);
        var dropElement = helpers.build(window.__html__['Coral.DragAction.drop.html']);
        var dragAction = new Coral.DragAction(dragElement);
    ...
    describe('#handle', function() {
      ...
      it('should set a DOM as handle', function() {
        var dragElement = helpers.build(window.__html__['Coral.DragAction.base.html']);
        var handleElement = helpers.build(window.__html__['Coral.DragAction.handle.html']);
        var dragAction = new Coral.DragAction(dragElement);
    ...
    describe('#axis', function() {
      ...
      it('should restrict the drag element to the horizontal axis', function() {
        ...
        var container = helpers.build(window.__html__['Coral.DragAction.container.html']);
        var dragElement = helpers.build(window.__html__['Coral.DragAction.base.html']);
  ...
  describe('Events', function() {
    ...
    it('should not trigger coral-dragaction:drop', function() {
      ...
      var dropZone = helpers.build(window.__html__['Coral.DragAction.drop.html']);
      var dragElement = helpers.build(window.__html__['Coral.DragAction.base.html']);
