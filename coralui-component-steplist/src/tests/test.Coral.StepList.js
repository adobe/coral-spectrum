describe('Coral.StepList', function() {
  ...
  describe('Instantiation', function() {
    it('should be possible using new', function() {
      var el = helpers.build(new Coral.StepList());
    ...
    it('should be possible to clone the element using markup', function() {
      helpers.cloneComponent(window.__html__['Coral.StepList.base.html']);
    });
  
    it('should be possible to clone using js', function() {
      const el = new Coral.StepList();
      el.items.add();
      el.items.add();
      el.items.add();
  ...
  describe('API', function() {
    ...
    beforeEach(function() {
      el = helpers.build(new Coral.StepList());
  ...
  describe('Markup', function() {
    ...
    describe('#selectedItem', function() {
      it('should default to the first item', function() {
        const el = helpers.build(window.__html__['Coral.StepList.base.html']);
        expect(el.selectedItem).to.equal(el.items.getAll()[0]);
      });

      it('should take the last selected', function() {
        helpers.target.innerHTML = window.__html__['Coral.StepList.doubleselected.html'];
  ...
  describe('Implementation Details', function() {
    ...
    it('should select the target after being inserted in the DOM', function(done) {
      helpers.build(window.__html__['Coral.StepList.virtualtarget.html']);
  ...
  describe('Collection API', function() {
    ...
    it('triggers coral-collection:remove on removeChild', function(done) {
      ...
      el = helpers.build(window.__html__['Coral.StepList.base.html']);
    ...
    it('#add should also support config', function(done) {
      ...
      expect(ret instanceof Coral.Step).to.be.true;
