      ...
      helpers.next(function() {
        ...
        helpers.next(function() {
          ...
          helpers.next(function() {
            ...
            helpers.keydown('enter', el1._elements.input);

            expect(el1.value).to.equal(el1.items.first().value, 'new value should match value of item selected using keyboard');
