describe('Coral.ActionBar', function() {
  ...
  describe('Instantiation', function() {
    it('should be possible to clone via markup', function() {
      helpers.cloneComponent(window.__html__['Coral.ActionBar.base.html']);
    });
  });
  ...
  describe('API', function() {
    ...
    beforeEach(function() {
      el = helpers.build(new Coral.ActionBar());
    });
  ...
  describe('Markup', function() {
    ...
    it('should be possible to instantiate a complex actionbar using markup', function() {
      const bar = helpers.build(window.__html__['Coral.ActionBar.base.html']);
    ...
    it('should be possible to instantiate a actionbar without wrapper components using markup', function() {
      const bar = helpers.build(window.__html__['Coral.ActionBar.containers.none.html']);
    ...
    describe('#coral-actionbar-container', function() {
      it('should generate the matching content zones with all containers', function() {
        const bar = helpers.build(window.__html__['Coral.ActionBar.container.multiple.html']);
      ...
      it('should generate the matching content zones with one container', function() {
        const bar = helpers.build(window.__html__['Coral.ActionBar.container.single.html']);
      ...
      it('should copy the container configurations to the new container', function() {
        const el = helpers.build(window.__html__['Coral.ActionBar.containers.legacy.html']);
      ...
      it('should copy content into new container', function() {
        const bar = helpers.build(window.__html__['Coral.ActionBar.container.content.html']);
  ...
  describe('User Interaction', function() {
    ...
    it('should open a popover on click on "more" button without throwing an exception if all items are disabled', function() {
      const bar = helpers.build(window.__html__['Coral.ActionBar.disabled.html']);
