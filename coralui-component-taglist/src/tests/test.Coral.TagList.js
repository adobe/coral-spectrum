describe('Coral.TagList', function() {
  ...
  describe('Instantiation', function() {
    it('should be possible to clone a taglist with one tag using markup', function() {
      helpers.cloneComponent(window.__html__['Coral.TagList.base.html']);
    });
    
    it('should be possible to clone a taglist with multiple tags using markup', function() {
      helpers.cloneComponent(window.__html__['Coral.TagList.full.html']);
    });
  ...
  describe('Markup', function() {
    ...
    describe('#items', function() {
      it('#items cannot be set', function() {
        var tagList = helpers.build(window.__html__['Coral.TagList.base.html']);
    ...
    describe('#values', function() {
      it('should get an array of values', function() {
        var eventSpy = sinon.spy();
        var tagList = helpers.build(new Coral.TagList());
    ...
    describe('#value', function() {
      ...
      it('should submit the form with taglist values', function() {
        var tagList = helpers.build(window.__html__['Coral.TagList.full.html']);
        var all = tagList.items.getAll();
