describe('Coral.Autocomplete.Item', function() {
  ...
  describe('API', function() {
    ...
    beforeEach(function() {
      el = helpers.build(new Coral.Autocomplete.Item());
    });
  ...
  describe('Markup', function() {
    ...
    describe('#content', function() {
      it('should have content set to innerHTML if property not provided', function() {
        const el = helpers.build(window.__html__['Coral.Autocomplete.Item.base.html']);
      ...
      it('should support HTML content', function() {
        const el = helpers.build(window.__html__['Coral.Autocomplete.Item.full.html']);
