describe('Coral.Autocomplete', function() {
  ...
  describe('Instantiation', function() {
    it('should be possible to clone using markup', function() {
      helpers.cloneComponent(window.__html__['Coral.Autocomplete.base.html']);
    });

    it('should be possible to clone using js', function() {
      helpers.cloneComponent(new Coral.Autocomplete());
    });
  });
  ...
  describe('API', function() {
    ...
    beforeEach(function() {
      el = helpers.build(new Coral.Autocomplete());
  ...
  describe('Implementation Details', function() {
    ...
    it('should update accessibility label on toggle button when number of suggestions available', function(done) {
      var el = helpers.build(new Coral.Autocomplete());
