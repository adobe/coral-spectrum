describe('Coral.TabList', function() {
  ...
  describe('Instantiation', function() {
    ...
    it('should be possible using new', function() {
      var el = helpers.build(new Coral.TabList());
    ...
    it('should be possible via clone using markup', function() {
      helpers.cloneComponent(window.__html__['Coral.TabList.base.html']);
    });

    it('should be possible via clone using markup with textContent', function() {
      helpers.cloneComponent(window.__html__['Coral.TabList.selectedItem.html']);
    });
  ...
  describe('Markup', function() {
    ...
    describe('#target', function() {
      it('should default to null', function() {
        const el = helpers.build(window.__html__['Coral.TabList.base.html']);
        expect(el.target).to.be.null;
      });

      it('should not fail with empty string', function() {
        const el = helpers.build(window.__html__['Coral.TabList.target.html']);
        expect(el.target).to.equal('');
      });

      it('should select the target after being inserted in the DOM', function(done) {
        helpers.build(window.__html__['Coral.TabList.virtualtarget.html']);
    ...
    describe('#selectedItem', function() {
      ...
      it('should take the last selected', function() {
        helpers.target.innerHTML = window.__html__['Coral.TabList.doubleselected.html'];
  ...
  describe('Collection API', function() {
    ...
    it('triggers coral-collection:remove on removeChild', function(done) {
      ...
      var el = helpers.build(window.__html__['Coral.TabList.base.html']);
    ...
    it('#add should also support config', function(done) {
      ...
      expect(ret instanceof Coral.Tab).to.be.true;
