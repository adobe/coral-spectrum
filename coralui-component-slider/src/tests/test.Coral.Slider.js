describe('Coral.Slider', function() {
  ...
  describe('Namespace', function() {
    it('should be defined', function() {
      ...
      expect(Coral.Slider).to.have.property('Item');
    });
  ...
  describe('Instantiation', function() {
    it('should be possible to clone the element using markup', function() {
      helpers.cloneComponent(window.__html__['Coral.Slider.base.html']);
    });
  
    it('should be possible to clone using js', function() {
      helpers.cloneComponent(new Coral.Slider());
    });
  });
  ...
  describe('API', function() {
    ...
    beforeEach(function() {
      el = helpers.build(new Coral.Slider());
    });
