describe('Coral.ColorInput', function() {
  describe('Namespace', function() {
    it('should be defined', function() {
      ...
      expect(Coral.ColorInput).to.have.property('Slider');
      expect(Coral.ColorInput).to.have.property('Swatch');
      expect(Coral.ColorInput).to.have.property('Swatches');
      expect(Coral.ColorInput).to.have.property('ColorProperties');
    });
  });
  
  describe('Instantiation', function() {
    it('should be possible to clone the element using markup', function() {
      helpers.cloneComponent(window.__html__['Coral.ColorInput.base.html']);
    });
  
    it('should be possible via cloneNode using js', function() {
      helpers.cloneComponent(new Coral.ColorInput());
    });
  });
  ...
  describe('API', function() {
    ...
    beforeEach(function() {
      el = helpers.build(new Coral.ColorInput());
    });
    ...
    describe('#valueAsColor', function() {
      ...
      it('should be possible to get/set the value as Coral.Color instead of a string', function() {
  ...
  describe('Markup', function() {
    ...
    describe('#labelledby', function() {
      it('should be possible to set labelledBy using markup', function() {
        const div = helpers.build(window.__html__['Coral.ColorInput.labelledBy.html']);
    ...
    describe('#showDefaultColors', function() {
      it('should be possible to add custom color with default colors using markup', function() {
        const el = helpers.build(window.__html__['Coral.ColorInput.showDefaultColors.on.html']);
        expect(el.showDefaultColors).to.equal(Coral.ColorInput.showDefaultColors.ON, 'default colors should be added by default');
      ...
      it('should be possible to add custom color without default colors using markup', function() {
        const el = helpers.build(window.__html__['Coral.ColorInput.showDefaultColors.off.html']);
